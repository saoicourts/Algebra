...
\begin{thm}[Van den Bergh]\label{thm-VdB}
...
\end{prf}
\begin{prf}[of theorem~\ref{thm-VdB}]
	\begin{align*}
...
\end{defn}
\begin{thm}[Koszul Duality: Beilinson-Ginzburg-Soergel]
...
\end{defn}
\begin{thm}[Beilinson-Gelfand-Gelfand]
